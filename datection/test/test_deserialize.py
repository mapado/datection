...
class TestDeserialize(unittest.TestCase):
    ...
    def test_deserialize_date(self):
        ...
        assert isinstance(date, datection.normalizer.Date)
        ser = date.serialize()
    ...
    def test_deserialize_time(self):
        ...
        assert isinstance(time, datection.normalizer.TimeInterval)
        ser = time.serialize()
    ...
    def test_deserialize_date_list(self):
        ...
        assert isinstance(datelist, datection.normalizer.DateList)
    ...
    def test_deserialize_date_interval(self):
        ...
        assert isinstance(dateinterval, datection.normalizer.DateInterval)
    ...
    def test_deserialize_datetime(self):
        ...
        assert isinstance(datetime, datection.normalizer.DateTime)
    ...
    def test_deserialize_datetime_list(self):
        ...
        assert isinstance(datetimelist, datection.normalizer.DateTimeList)
    ...
    def test_deserialize_datetime_interval(self):
        ...
        assert isinstance(datetimeinterval, datection.normalizer.DateTimeInterval)
