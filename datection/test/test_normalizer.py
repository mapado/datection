...
class TestFrDateNormalizer(unittest.TestCase):
    ...
    def test_valid_litteral_date(self):
        ...
        date = parse('le lundi 5 mars 2013', 'fr')[0]
        assert date.valid
    ...
    def test_invalid_dates(self):
        ...
        assert parse('5/03', 'fr')[0].valid is False
        assert parse('lundi 5 mars', 'fr')[0].valid is False
...
class TestFrTimeIntervalNormalizer(unittest.TestCase):
    ...
    def test_valid_time_interval(self):
        ...
        time = parse('de 15h30 à 16h', 'fr')[0]
        assert time.valid
        assert time.timepoint == 'time_interval'
        time_norm = time.to_dict()
        assert time_norm['start_time']['hour'] == 15
    ...
    def test_all_interval_formats(self):
        ...
        assert parse('15h30', 'fr')[0] == parse('15:30', 'fr')[0]
        assert parse('de 15h à 18h', 'fr')[0] == parse('15h-18h', 'fr')[0]
        assert parse('entre 15h et 18h', 'fr')[0] == parse('15h-18h', 'fr')[0]
...
class TestFrDateListNormalizer(unittest.TestCase):
    ...
    def test_valid_format(self):
        ...
        datelist = parse('le 5, 6 et 7 octobre 2013', 'fr')[0]
    ...
    def test_missing_year(self):
        ...
        datelist = parse('le 5, 6 et 7 octobre', 'fr')[0]
        assert datelist.timepoint == 'date_list'
...
class TestFrDateTime(unittest.TestCase):
    ...
    def test_valid_format(self):
        ...
        datetime = parse('le lundi 15 mars 2013 à 20h', 'fr')[0]
    ...
    def test_all_formats(self):
        dt1 = parse('le lundi 15 mars 2013 de 15h à 20h', 'fr')[0]
        dt2 = parse('le lundi 15 mars 2013, 15h-20h', 'fr')[0]
        assert dt1 == dt2
...
class TestFrDateTimeList(unittest.TestCase):
    ...
    def test_valid_format(self):
        """ Test the normaliser on a valid format."""
        datetimelist = parse('les 6 et 9 octobre 2013 de 15h à 20h', 'fr')[0]
    ...
    def test_all_formats(self):
        dtl1 = parse('les 6 et 9 octobre 2013, 15h - 20h', 'fr')[0]
        dtl2 = parse('6, 9 octobre 2013 entre 15h et 20h', 'fr')[0]
        dtl3 = parse('6, 9 octobre 2013 de 15h à 20h', 'fr')[0]
